...
# Comparación entre dos regiones: costa norte y sierra sur. Primero, 
agrupar proporción de percepción de que empresas respetan derechos
humanos en costa norte (Piura, Tumbes, Lambayeque y La Libertad). Resultados 
ponderados al factor de ponderación.
...
data6 = data.frame(Dónde=c("Costa norte", "Costa norte", "Sierra sur", 
"Sierra sur"), Percepción=c("Respetan", "No respetan",
