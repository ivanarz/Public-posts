...
# Creación de dos conjuntos de datos: quienes consideran que
grandes empresas sí respetan derechos humanos y quienes consideran que no.
...
# Comparación entre dos regiones: costa norte y sierra sur. Primero, ver
distribución de departamentos por regiones.

table(DH$REGION)

# Luego, agrupar proporción de percepción de que empresas respetan derechos
humanos en costa norte (Áncash, Piura, Tumbes, Lambayeque y La Libertad). 
...
# Luego, hacer lo mismo con sierra central (Huánuco, Huancavelica, 
Junín, Pasco).
